...
class SnapchatMapWidget extends StatefulWidget {
  final List<HeatPoint> heatPoints;
  final LocationPoint centerLocation;
  final Function(HeatPoint) onHeatPointTapped;

  const SnapchatMapWidget({
    Key? key,
  ...
  @override
  State<SnapchatMapWidget> createState() => _SnapchatMapWidgetState();
}

class _SnapchatMapWidgetState extends State<SnapchatMapWidget>
  ...
  Offset _locationToMapCoordinates(LocationPoint location) {
    ...
    const double latScale = 100000.0; // Adjust based on desired map size
                ...
                child: Center(
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: math.min(16, heatPoint.heatRadius / 3),
                      shadows: [
                        Shadow(
  ...
  Widget _buildCenterMarker() {
    final Offset position = _locationToMapCoordinates(widget.centerLocation);
